...
$role_access = [
    'superadmin'    => ['*'],
    'admin'         => ['dashboard','blog','produk','layanan','gallery','pages','menu','pengaturan','seo','ads','plugin','users','content','testimonial','faq','klien-logo','wizard','template','flex-blocks','grid-icon','solusi','industri','solusi-pilar','career','career-lamaran','terjemahan'],
...
// Valid pages
$valid_pages = ['dashboard','blog','produk','layanan','gallery','pages','menu','pengaturan','plugin','ads','seo','users','wizard','content','testimonial','faq','klien-logo','template','flex-blocks','grid-icon','blog-kategori','produk-kategori','solusi','industri','solusi-pilar','career','career-lamaran','terjemahan'];
